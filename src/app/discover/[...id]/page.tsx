...
const Discover = () => {
  ...
  useEffect(() => {
    ...
    switch (id) {
      case "now_playing":
        settile("Now Playing Movies")
        break;
      case "top_rated":
        settile("Top Rated Movies")
        break;
      case "upcoming":
        settile("Upcoming Movies")
        break;
      case "popular":
        settile("Popular Movies")
        break;
      default:
        settile("")
        break;
  ...
  return (
    ...
    scrollbar-thin scrollbar-thumb-[#22222a] scrollbar-track-black relative' ref={mainRef}>
      ...
      <div className='grid md:grid-cols-3 xl:grid-cols-5 grid-cols-2  gap-8 movieGrid place-items-center mt-8'>
        {
